...
call %VSVARS%
if %FOUND_VC%==1 (
	msbuild %SOURCE_DIR%\bin\Windows_10\x86\INSTALL.vcxproj /p:Configuration="Release" /p:Platform="Win32"
	msbuild %SOURCE_DIR%\bin\Windows_10\arm\INSTALL.vcxproj /p:Configuration="Release" /p:Platform="ARM"
) else (
    echo Script error.
    goto ERROR
)
