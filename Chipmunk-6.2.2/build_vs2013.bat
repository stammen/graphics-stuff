...
if %FOUND_VC%==1 (
    ...
    msbuild  Chipmunk-6.2.2\bin\WindowsPhone_8.1\win32\INSTALL.vcxproj /p:Configuration="MinSizeRel"  /p:Platform="Win32" /p:ForceImportBeforeCppTargets=%cd%\winrt.props /m
    msbuild  Chipmunk-6.2.2\bin\WindowsPhone_8.1\arm\INSTALL.vcxproj /p:Configuration="MinSizeRel"  /p:Platform="ARM" /p:ForceImportBeforeCppTargets=%cd%\winrt.props /m
    msbuild  Chipmunk-6.2.2\bin\WindowsStore_8.1\win32\INSTALL.vcxproj /p:Configuration="MinSizeRel"  /p:Platform="Win32" /p:ForceImportBeforeCppTargets=%cd%\winrt.props /m
    msbuild  Chipmunk-6.2.2\bin\WindowsStore_8.1\arm\INSTALL.vcxproj /p:Configuration="MinSizeRel"  /p:Platform="ARM" /p:ForceImportBeforeCppTargets=%cd%\winrt.props /m
